...
class _NavHomeState extends State<NavHome> with WidgetsBindingObserver {
  int currentPage = 0;
  ...
  Widget build(BuildContext context) {
    ...
    GeoCollectionReference<Map<String, dynamic>>(collectionReference)
        ...
        queryBuilder: (query) =>
            query.where("isVerified", isEqualTo: false),
        strictMode: true);
          ...
          children: [
            Form(
                child: DelayedDisplay(
                    child: Card(
                      ...
                      child: TextFormField(
                        onTap: () {
                          // PageRouter.push(context, className);
                        },
                        readOnly: true,
            ...
            Column(
              children: [
                ...
                docs.isEmpty ? Image.asset("assets/noResults.png")  :  ListView.builder(
